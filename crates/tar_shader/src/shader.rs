...
const _: () = assert!(
    std::mem::size_of:: < UniformData > () == 160,
...
const _: () = assert!(
    memoffset::offset_of!(UniformData, camera_pos) == 144,
    "offset of UniformData.camera_pos does not match WGSL"
);
#[repr(C)]
#[derive(
    Debug,
...
pub mod bind_groups {
    ...
    pub struct BindGroupLayout1<'a> {
        ...
        pub occlusion_tex: &'a wgpu::TextureView,
    }
